    ...
    <div className="py-12">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-4xl font-bold text-center mb-8">About ClinkDrop</h1>

          <div className="mb-12 relative h-64 md:h-96 rounded-xl overflow-hidden">
            <Image src="/placeholder.svg?height=600&width=1200" alt="ClinkDrop Team" fill className="object-cover" />
          </div>

          <div className="prose prose-lg max-w-none">
            <h2>Our Mission</h2>
            <p>
              At ClinkDrop, we're on a mission to transform education through the power of artificial intelligence. We
            ...
            <h2>Our Story</h2>
            <p>
              Founded in 2023 by a team of educators, AI researchers, and education technology experts, ClinkDrop was born
